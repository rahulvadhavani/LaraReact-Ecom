...
import MobileBottomBar from '@/Components/Admin/Navbar/MobileBottomBar'
    ...
    return (
        <>
            <nav
                ...
                className={`sticky top-0 z-10 flex items-center justify-between px-6 py-4 transition-transform duration-500 bg-white dark:bg-dark-eval-1 ${isScrollDown && '-translate-y-full'
