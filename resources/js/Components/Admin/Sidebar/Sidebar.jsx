...
import SidebarContent from '@/Components/Admin/Sidebar/SidebarContent'

const SidebarOverlay = () => {
    const { isSidebarOpen, setSidebarOpen } = useContext(AdminGlobalContext)
...
const SidebarHeader = () => {
    ...
    return (
        <div className="flex items-center justify-between flex-shrink-0 px-3">
            <Link href={route('admin.dashboard')} className="inline-flex">
...
export const SidebarLink = ({
    ...
    const { isSidebarOpen, isSidebarHovered } = useContext(AdminGlobalContext)
